...
# load GEFS data and ERA5 data (for obs PW analysis) and GPCP data (for obs precip analysis) from 2000 to 2001
### data structure:  2, 123, 16, 41, 360   <=> iyear, iday, forecast lead time, ilat, ilon
